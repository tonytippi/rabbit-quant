    ...
    try:
        ...
        if args.sweep:
            ...
            result = run_backtest(
                ...
                ltf_metric=ltf_metric_df.values, htf_metric=htf_metric_df.values, volatility_zscore=vol_z_df.values,
                htf_direction=htf_dir_df.values, rank_metric=rank_metric_df.values,
                macro_filter_type=_strategy.macro_filter_type,
                htf_threshold=_strategy.htf_threshold,
                ltf_threshold=_strategy.ltf_threshold,
                veto_threshold=_strategy.veto_threshold,
